...
def start_corenlp(port, classpath='/home/edwlee/Documents/stanford/cs230/stanford-corenlp-4.1.0/*'):
    """Make sure to set CLASSPATH"""
    command = 'java -cp "{}" -mx4g edu.stanford.nlp.pipeline.StanfordCoreNLPServer -quiet -port {} -timeout 15000'.format(classpath, port)
